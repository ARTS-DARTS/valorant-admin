...
class _TrajectoryPainter extends CustomPainter {
  ...
  const _TrajectoryPainter({required this.points, required this.progress, required this.color});
  ...
  bool shouldRepaint(_TrajectoryPainter old) =>
      old.progress != progress || old.points.length != points.length || old.color != color;
}
