...
class _UserProfileScreenState extends State<UserProfileScreen>
  ...
  String get _avatarUrl {
    final d = _userData ?? {};
    return ((d['avatar_url'] ?? d['photo_url'] ?? d['photoURL']) ?? '')
        as String;
  }
          ...
          Container(
            ...
            child: CircleAvatar(
              ...
              backgroundImage: avatar.isNotEmpty
                  ? CachedNetworkImageProvider(avatar, cacheManager: AppImageCache.manager)
                  : null,
              child: avatar.isEmpty
                  ? Icon(Icons.person, color: t.textSecondary, size: 40)
                  : null,
            ),
          ),
